...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, isLanding = false, ...props }, ref) => {
    const Comp = asChild ? Slot : "button"
    const variants = isLanding ? landingButtonVariants : dashboardButtonVariants
...
const buttonVariants = dashboardButtonVariants

export { Button, dashboardButtonVariants, landingButtonVariants, buttonVariants }
